...
public class ChangePassword extends Fragment implements AsyncResponse {
            ...
            public void onClick(View v) {
                ...
                else
                {
                    ...
                    if (networkInfo != null && networkInfo.isConnected()) {
                        String url = Const.StudentChangePwd;
                        backgroundWorker.delegate = (AsyncResponse) ChangePassword.this;
                        HashMap<String, String> parms = new HashMap<>();
                        parms.put("old_pwd", et_old_pwd.getText().toString());
                        parms.put("new_pwd", et_new_pwd.getText().toString());
                        parms.put("student_id", session.getStudentid());
